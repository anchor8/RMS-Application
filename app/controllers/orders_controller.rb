class OrdersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order.save
        format.html { redirect_to ordermgmt_url, notice: " P.O. No. " + @order.purchase_order_number + " was successfully added." }
  ...
  def update
    respond_to do |format|
      if @order.update(order_params)
        format.html { redirect_to ordermgmt_url, notice: " P.O. No. " + @order.purchase_order_number + " was successfully updated." }
