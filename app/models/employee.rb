...
class Employee < ApplicationRecord
  ...
  validates :fname, allow_blank: false, presence: true, format: { with: /\A^\s*[a-zA-Z',\s]+\s*$\z/, message: "- Only letters, commas, apostrophes, or spaces for first name allowed"}
  validates :lname, allow_blank: false, presence: true, format: { with: /\A^\s*[a-zA-Z',\s]+\s*$\z/, message: "- Only letters, commas, apostrophes, or spaces for last name allowed"}
